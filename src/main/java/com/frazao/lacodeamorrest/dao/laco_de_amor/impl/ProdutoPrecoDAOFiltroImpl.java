...
import com.frazao.lacodeamorrest.dao.laco_de_amor.ProdutoPrecoDAOFiltro;
...
public class ProdutoPrecoDAOFiltroImpl implements ProdutoPrecoDAOFiltro {
	...
	@Override
	public Collection<ProdutoPreco> filtrar(final ProdutoPrecoFiltroDTO f) {

		final StringBuilder sql = new StringBuilder();
		sql.append("SELECT em.*").append("\n");
		sql.append("FROM   ").append(this.databaseSchema).append(".produto_preco as em").append("\n");
		...
		final Query query = this.entityManager.createNativeQuery(sql.toString(), ProdutoPreco.class);
		if (ObjectUtils.isNotEmpty(idSim)) {
