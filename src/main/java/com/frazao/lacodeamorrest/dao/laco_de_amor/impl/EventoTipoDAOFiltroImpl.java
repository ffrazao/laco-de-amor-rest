...
import com.frazao.lacodeamorrest.dao.laco_de_amor.EventoTipoDAOFiltro;
...
public class EventoTipoDAOFiltroImpl implements EventoTipoDAOFiltro {
	...
	@Override
	public Collection<EventoTipo> filtrar(final EventoTipoFiltroDTO f) {

		final StringBuilder sql = new StringBuilder();
		sql.append("SELECT em.*").append("\n");
		sql.append("FROM   ").append(this.databaseSchema).append(".evento_tipo as em").append("\n");
		...
		final Query query = this.entityManager.createNativeQuery(sql.toString(), EventoTipo.class);
		if (ObjectUtils.isNotEmpty(idSim)) {
