...
import com.frazao.lacodeamorrest.dao.laco_de_amor.ProdutoDescricaoDAOFiltro;
...
public class ProdutoDescricaoDAOFiltroImpl implements ProdutoDescricaoDAOFiltro {
	...
	@Override
	public Collection<ProdutoDescricao> filtrar(final ProdutoDescricaoFiltroDTO f) {

		final StringBuilder sql = new StringBuilder();
		sql.append("SELECT em.*").append("\n");
		sql.append("FROM   ").append(this.databaseSchema).append(".produto_descricao as em").append("\n");
		...
		final Query query = this.entityManager.createNativeQuery(sql.toString(), ProdutoDescricao.class);
		if (ObjectUtils.isNotEmpty(idSim)) {
