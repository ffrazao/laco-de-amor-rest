...
import com.frazao.lacodeamorrest.dao.laco_de_amor.EventoPessoaDAOFiltro;
...
public class EventoPessoaDAOFiltroImpl implements EventoPessoaDAOFiltro {
	...
	@Override
	public Collection<EventoPessoa> filtrar(final EventoPessoaFiltroDTO f) {

		final StringBuilder sql = new StringBuilder();
		sql.append("SELECT em.*").append("\n");
		sql.append("FROM   ").append(this.databaseSchema).append(".evento_pessoa as em").append("\n");
		...
		final Query query = this.entityManager.createNativeQuery(sql.toString(), EventoPessoa.class);
		if (ObjectUtils.isNotEmpty(idSim)) {
